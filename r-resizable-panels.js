var r_resizable_panels = {
    ...
    init: function () {
        ...
        for (var i = 0; i < groups.length; i++) {
            ...
            this.model.push({ element: element, panels: panels, oriention: oriention, dimentions: dimentions, thickness: thickness });
        }
        this.update();
    },
    update: function () {
    ...
    mouseMove: function (e) {
        ...
        if (r_resizable_panels.start.oriention === "horizontal") {
            ...
            if (beforePanelWidth < 50) {
                return;
            }
            var afterPanelWidth = afterPanel.width - offset;
            if (afterPanelWidth < 50) {
                return;
            }
            ...
            if (beforePanelHeight < 50) {
                return;
            }
            var afterPanelHeight = afterPanel.height - offset;
            if (afterPanelHeight < 50) {
                return;
            }
